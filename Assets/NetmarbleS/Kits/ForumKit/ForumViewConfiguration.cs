namespace NetmarbleS
{
    ...
    public class ForumViewConfiguration
    {
        ...
        private ForumViewConfiguration.ControllerBarConfiguration controllerBarConfiguration;
		...
		public static extern IntPtr nmg_forum_getDefaultValue();
#endif

        public ForumViewConfiguration()
        {
            string defaultValue = null;
            Log.Debug("[Forum] GetDefaultValue");
#if !UNITY_EDITOR && UNITY_ANDROID
            AndroidJavaClass forumClass = new AndroidJavaClass("com.netmarble.unity.NMGForumUnity");
            defaultValue = forumClass.CallStatic<string>("nmg_forum_getDefaultValue");
#elif !UNITY_EDITOR && (UNITY_IPHONE || UNITY_IOS)
			defaultValue = Marshal.PtrToStringAuto(nmg_forum_getDefaultValue());
#endif
            Log.Debug("[Forum] GetDefaultValue : " + defaultValue);
        ...
        public ForumViewConfiguration.ControllerBarConfiguration ControllerBarConfig
        {
            get
            {
