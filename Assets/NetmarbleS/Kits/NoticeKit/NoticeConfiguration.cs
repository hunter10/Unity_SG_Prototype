namespace NetmarbleS
{
    ...
    public class NoticeViewConfiguration
    {
        ...
        private NoticeViewConfiguration.ControllerBarConfiguration controllerBarConfiguration;
		...
		public static extern IntPtr nmg_notice_getDefaultValue();
#endif

        public NoticeViewConfiguration()
        {
            string defaultValue = null;
            Log.Debug("[Notice] GetDefaultValue");
#if !UNITY_EDITOR && UNITY_ANDROID
            AndroidJavaClass noticeClass = new AndroidJavaClass("com.netmarble.unity.NMGNoticeUnity");
            defaultValue = noticeClass.CallStatic<string>("nmg_notice_getDefaultValue");

#elif !UNITY_EDITOR && (UNITY_IPHONE || UNITY_IOS)
			defaultValue = Marshal.PtrToStringAuto(nmg_notice_getDefaultValue());
#endif
            Log.Debug("[Notice] DefaultValuie : " +  defaultValue);
		...
		public NoticeViewConfiguration.ControllerBarConfiguration ControllerBarConfig
		{
			get
			{
