namespace NetmarbleS
{
    ...
    public class CustomerSupportViewConfiguration
    {
        ...
        private CustomerSupportViewConfiguration.ControllerBarConfiguration controllerBarConfiguration;
        ...
        public static extern IntPtr nmg_cs_getDefaultValue();
#endif

        public CustomerSupportViewConfiguration()
        {
            string defaultValue = null;
            Log.Debug("[CustomerSupportViewConfiguration] GetDefaultValue");
#if !UNITY_EDITOR && UNITY_ANDROID
            AndroidJavaClass customerSupportClass = new AndroidJavaClass("com.netmarble.unity.NMGCustomerSupportUnity");
            defaultValue = customerSupportClass.CallStatic<string>("nmg_cs_getDefaultValue");

#elif !UNITY_EDITOR && (UNITY_IPHONE || UNITY_IOS)
			defaultValue = Marshal.PtrToStringAuto(nmg_cs_getDefaultValue());
#endif
            Log.Debug("[CustomerSupportViewConfiguration] DefaultValuie : " + defaultValue);
        ...
        public CustomerSupportViewConfiguration.ControllerBarConfiguration ControllerBarConfig
        {
            get
            {
