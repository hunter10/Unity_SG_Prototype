namespace NetmarbleS
{
    ...
    public class PromotionViewConfiguration
    {
        ...
        private PromotionViewConfiguration.ControllerBarConfiguration controllerBarConfiguration;
		...
		public static extern IntPtr nmg_promotion_getDefaultValue();
#endif

        public PromotionViewConfiguration()
        {
            string defaultValue = null;
            Log.Debug("[Promotion] GetDefaultValue");
#if !UNITY_EDITOR &&  UNITY_ANDROID
            AndroidJavaClass promotionClass = new AndroidJavaClass("com.netmarble.unity.NMGPromotionUnity");
            defaultValue = promotionClass.CallStatic<string>("nmg_promotion_getDefaultValue");

#elif !UNITY_EDITOR && (UNITY_IPHONE || UNITY_IOS)
			defaultValue = Marshal.PtrToStringAuto(nmg_promotion_getDefaultValue());
#endif
            Log.Debug("[Promotion] GetDefaultValue : " + defaultValue);
		...
		public PromotionViewConfiguration.ControllerBarConfiguration ControllerBarConfig
		{
			get
			{
